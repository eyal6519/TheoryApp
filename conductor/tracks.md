...
| :--- | :--- | :--- |
| `001-project-setup` | [Project Initialization](./tracks/001-project-setup/index.md) | `COMPLETED` |
...
| `005-random-order` | [Randomized Question Order](./tracks/005-random-order/index.md) | `NOT_STARTED` |
